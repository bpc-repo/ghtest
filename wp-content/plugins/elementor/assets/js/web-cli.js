...
function createImmutableStateInvariantMiddleware(options) {
    if (options ==€gÂ‰}U  €gÂ‰}U                  @=¶‰}U          €”§‰}U  ègÂ‰}U           gÂ‰}U   @       gÂ‰}U          oid 0 ? isImmutableDefault : _b, ignoredPaths = options.ignoredPaths, _c = options.warnAfter, warnAfter = _c === void 0 ? 32 : _c, ignore = options.ignore;
...
function createSlice(options) {
    ...
    var _b = typeof options.extraReducers === "function" ? executeReducerBuilderCallback(options.extraReducers) : [options.extraReducers], _c = _b[0], extraReducers = _c === void 0 ? {} : _c, _d = _b[1], actionMatchers = _d === void 0 ? [] : _d, _e = _b€gÂ‰}U  €gÂ‰}U                  @=¶‰}U          €”§‰}U  ègÂ‰}U           gÂ‰}U   @       gÂ‰}U             var sliceCaseReducersByName = {};
